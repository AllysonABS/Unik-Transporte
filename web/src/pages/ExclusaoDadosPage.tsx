    ...
    <div className="min-h-screen bg-matriz text-clareza">
      ...
      <main className="max-w-2xl mx-auto px-5 md:px-8 pt-28 pb-20">
        ...
        <form onSubmit={handleSubmit} className="bg-card border border-border rounded-2xl p-6 md:p-8 space-y-5">
          ...
          <div>
            <label className="text-gray text-xs font-medium block mb-1.5">Nome completo *</label>
            <input
              type="text"
              value={form.nome}
          ...
          <div>
            <label className="text-gray text-xs font-medium block mb-1.5">CPF ou CNPJ *</label>
            <input
              type="text"
          ...
          <div>
            <label className="text-gray text-xs font-medium block mb-1.5">E-mail cadastrado *</label>
            <input
              type="email"
              value={form.email}
          ...
          <div>
            <label className="text-gray text-xs font-medium block mb-1.5">Motivo da exclusão (opcional)</label>
            <textarea
              value={form.motivo}
          ...
          <div className="flex items-start gap-3 pt-2">
            ...
            />
            <label htmlFor="confirmacao" className="text-gray text-sm">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full h-14 bg-danger text-white font-bold text-base rounded-xl hover:bg-danger/90 active:scale-95 transition-all disabled:opacity-60 disabled:pointer-events-none"
          >
            {loading ? 'Enviando...' : 'Solicitar Exclusão de Dados'}
          </button>
        </form>

        <p className="text-gray/80 text-xs text-center mt-6">
