...
const s = StyleSheet.create({
  ...
  card:        {backgroundColor: '#102255', borderRadius: 12, padding: 16, flexDirection: 'row', gap: 12, borderWidth: 1, borderColor: '#1E3A6B'},
  ...
  entregarBtn: {backgroundColor: '#102255', borderRadius: 8, paddingHorizontal: 12, paddingVertical: 8, borderWidth: 1, borderColor: Colors.pulso, flexDirection: 'row', alignItems: 'center', gap: 4},
  entregarText:{color: Colors.pulso, fontWeight: '700', fontSize: 13},
  detalhesBtn: {backgroundColor: '#102255', borderRadius: 8, paddingHorizontal: 12, paddingVertical: 8, borderWidth: 1, borderColor: '#60A5FA', flexDirection: 'row', alignItems: 'center', gap: 4},
