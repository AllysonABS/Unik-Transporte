...
const s = StyleSheet.create({
  ...
  resumoCard:   {flex: 1, backgroundColor: '#081544', borderRadius: 10, padding: 12, alignItems: 'center', borderWidth: 1, borderColor: '#0B1E5A'},
  ...
  searchBox:    {flexDirection: 'row', alignItems: 'center', marginHorizontal: 24, marginBottom: 10, backgroundColor: '#081544', borderRadius: 10, borderWidth: 1, borderColor: '#0B1E5A', paddingHorizontal: 14},
