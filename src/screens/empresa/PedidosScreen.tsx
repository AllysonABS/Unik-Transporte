...
const s = StyleSheet.create({
  ...
  searchBox:    {flexDirection: 'row', alignItems: 'center', marginHorizontal: 24, marginBottom: 10, backgroundColor: '#102255', borderRadius: 10, borderWidth: 1, borderColor: '#1E3A6B', paddingHorizontal: 14, gap: 8},
  ...
  filtroChip:   {backgroundColor: '#102255', borderRadius: 20, paddingHorizontal: 14, paddingVertical: 8, borderWidth: 1, borderColor: '#1E3A6B'},
  ...
  progressBg:   {flex: 1, height: 6, backgroundColor: '#1E3A6B', borderRadius: 3, overflow: 'hidden'},
  ...
  selectBtn:    {height: 50, backgroundColor: '#102255', borderRadius: 8, borderWidth: 1, borderColor: '#1E3A6B', paddingHorizontal: 16, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between'},
