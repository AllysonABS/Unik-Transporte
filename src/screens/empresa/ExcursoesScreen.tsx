...
const s = StyleSheet.create({
  ...
  card:         {backgroundColor: '#102255', borderRadius: 12, padding: 16, borderWidth: 1, borderColor: '#1E3A6B'},
  cardTop:      {flexDirection: 'row', alignItems: 'center', gap: 10, marginBottom: 10},
  cardActions:  {flexDirection: 'row', gap: 12, marginLeft: 'auto'},
  iconBtn:      {fontSize: 18},
  menuPopup:    {backgroundColor: '#081544', borderRadius: 10, borderWidth: 1, borderColor: '#1E3A6B', width: 160, shadowColor: '#000', shadowOffset: {width: 0, height: 4}, shadowOpacity: 0.3, shadowRadius: 8, elevation: 10},
  menuItem:     {flexDirection: 'row', alignItems: 'center', gap: 10, paddingVertical: 12, paddingHorizontal: 14, borderBottomWidth: 1, borderBottomColor: '#1E3A6B'},
  ...
  vagaBadge:    {backgroundColor: '#1E3A6B', borderRadius: 6, paddingHorizontal: 10, paddingVertical: 4, flexDirection: 'row', gap: 4, alignItems: 'center'},
  ...
  sheet:        {backgroundColor: '#081544', borderTopLeftRadius: 20, borderTopRightRadius: 20, padding: 28, paddingBottom: 40},
  ...
  detRow:       {flexDirection: 'row', justifyContent: 'space-between', paddingVertical: 12, borderBottomWidth: 1, borderBottomColor: '#1E3A6B'},
  ...
  input:        {height: 50, backgroundColor: '#102255', borderRadius: 8, borderWidth: 1, borderColor: '#1E3A6B', paddingHorizontal: 16, color: Colors.clareza, fontSize: 15},
  ...
  cancelBtn:    {flex: 1, height: 52, backgroundColor: '#102255', borderRadius: 8, alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: '#EF4444'},
