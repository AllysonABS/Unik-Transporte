...
const s = StyleSheet.create({
  ...
  backBtn: {width: 48, height: 48, borderRadius: 14, backgroundColor: '#102255', alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: '#1E3A6B'},
  ...
  pill: {flexDirection: 'row', alignItems: 'center', backgroundColor: '#102255', paddingHorizontal: 12, paddingVertical: 8, borderRadius: 20, gap: 6, borderWidth: 1, borderColor: '#1E3A6B'},
  ...
  statCard: {flex: 1, backgroundColor: '#102255', borderRadius: 14, padding: 14, alignItems: 'center', borderWidth: 1, borderColor: '#1E3A6B'},
  ...
  pedidosList: {gap: 10},
  pedidoCard: {backgroundColor: '#102255', borderRadius: 12, padding: 16, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', borderWidth: 1, borderColor: '#1E3A6B'},
  pedidoLeft: {flex: 1, marginRight: 12},
  pedidoIdRow: {flexDirection: 'row', alignItems: 'center', gap: 8},
  pedidoData: {fontSize: 11, color: Colors.gray, backgroundColor: '#1E3A6B', paddingHorizontal: 8, paddingVertical: 2, borderRadius: 6},
  ...
  sheet: {backgroundColor: '#081544', borderTopLeftRadius: 24, borderTopRightRadius: 24, padding: 28, paddingBottom: 40},
  sheetHandle: {width: 40, height: 4, backgroundColor: '#1E3A6B', borderRadius: 2, alignSelf: 'center', marginBottom: 20},
  ...
  timelineDot: {width: 10, height: 10, borderRadius: 5, backgroundColor: '#1E3A6B', marginTop: 3},
  timelineBar: {width: 2, flex: 1, backgroundColor: '#1E3A6B', marginTop: 4},
  ...
  desvincularBtn: {height: 52, backgroundColor: '#102255', borderRadius: 12, alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: '#EF4444'},
  desvincularText: {color: '#EF4444', fontWeight: '700', fontSize: 15},
  confirmSheet: {backgroundColor: '#081544', borderRadius: 20, padding: 28, marginHorizontal: 32, alignItems: 'center'},
  ...
  confirmCancelBtn: {flex: 1, height: 48, backgroundColor: '#102255', borderRadius: 10, alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: '#1E3A6B'},
