...
const s = StyleSheet.create({
  ...
  resumoCard: {flex: 1, backgroundColor: '#102255', borderRadius: 10, padding: 14, alignItems: 'center', borderWidth: 1, borderColor: '#1E3A6B'},
  ...
  section:      {backgroundColor: '#102255', borderRadius: 12, borderWidth: 1, borderColor: '#1E3A6B', overflow: 'hidden', marginBottom: 16},
  ...
  row:          {flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', padding: 16, borderBottomWidth: 1, borderBottomColor: '#1E3A6B'},
  ...
  exitBtn:    {height: 52, backgroundColor: '#102255', borderRadius: 8, alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: '#EF4444'},
  ...
  input:      {height: 48, backgroundColor: '#102255', borderRadius: 8, borderWidth: 1, borderColor: '#1E3A6B', paddingHorizontal: 14, color: Colors.clareza, fontSize: 15},
